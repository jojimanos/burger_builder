...
setError('There was an error when signing in. Please check email and password.')
} 
  };
    }
  ...
  return (
    <div>
      <div className='bg-stone-200 min-h-screen max-h-max'>
        ...
        <div className='grid place-items-center'>
          {error && (<div className='bg-red-500 text-center text-xl font-bold p-2 rounded-lg'>{error}</div>)}
        </div>
