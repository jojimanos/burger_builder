...
export default function Home() {
  ...
  function addLettuce(items: number) {
    ...
    setArray((arr: any) => [
      ...arr,
      {
        ...
        element: (
          <div>
            <Image alt="" src={"/lettuce.jpg"} width={400} height={400} />
          </div>
        ),
      },
    ]);
  ...
  function addTomato(items: number) {
    ...
    setArray((arr: any) => [
      ...arr,
      {
        ...
        element: (
          <div>
            <Image alt="" src={"/tomato.jpg"} width={400} height={400} />
          </div>
        ),
      },
    ]);
  ...
  function addMeat(items: number) {
    ...
    setArray((arr: any) => [
      ...arr,
      {
        ...
        element: (
          <div>
            <Image alt="" src={"/meat.jpg"} width={400} height={400} />
          </div>
        ),
      },
    ]);
  ...
  function addCheese(items: number) {
    ...
    setArray((arr: any) => [
      ...arr,
      {
        ...
        element: (
          <div>
            <Image alt="" src={"/cheese.jpg"} width={400} height={400} />
          </div>
        ),
      },
    ]);
  ...
  const userOrders = ordersArray.filter(
    (order: any) => order.email === displayUser.email
  );
  ...
  const handleSubmit = async (event: any) => {
    ...
    try {
      addDoc(dbInstance, {
        ...
        .then(() => {
          setMessage("Your order has been sent");
        });
    } catch {
      console.log("Error");
    }
        ...
        <main>
          <div className="grid grid-cols-2">
            <div className="flex justify-end">
              <div className="w-64">
                <div>
                  <Image alt="" src={"/top.jpg"} width={400} height={400} />
                </div>
                <div>
                  {array.map((arr: any) => (
                    <div
                      ...
                      id={arr.id}
                      onClick={() => {
                        removeIngredient(arr.id, arr.key);
                      }}
                    >
                      {arr.element}
                    </div>
                ...
                <div>
                  <Image alt="" src={"/bottom.jpg"} width={400} height={400} />
                </div>
                {message && (
                  <div className="bg-green-600 rounder-md p-2 border-2 border-white">
                    {message}
                  </div>
                )}
              </div>
            </div>
            {isOpen && <Instructions handleClose={popUpWindow} />}
            {viewOrders && (
              <OrderList
                setViewOrders={setViewOrders}
                viewOrders={viewOrders}
            ...
            <div className="flex justify-center">
              <div className="grid place-items-center min-h-10 max-h-12">
                <form onSubmit={handleSubmit}>
                  <div className="py-2">
                    <button
                      ...
                      className="text-2xl font-extrabold text-zinc-400/80 hover:text-3xl"
                    >
                      Lettuce
                    </button>
                  ...
                  <div className="py-2">
                    ...
                    <span className="pl-2 text-xl text-gray-800">{tomato}</span>
                  </div>
                  <div className="py-2">
                    <button
                      type="button"
                    ...
                    <span className="pl-2 text-xl text-gray-800">{meat}</span>
                  </div>
                  <div className="py-2">
                    <button
                      type="button"
                    ...
                    <span className="pl-2 text-xl text-gray-800">{cheese}</span>
                  </div>
                  <button
                    className="bg-black text-white p-1 rounded-md border-2 border-gray-500"
                    type="submit"
                  >
                    Submit your Order
                  </button>
                ...
                <div onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
                  <button className={styles.neonText} onClick={popUpWindow}>
                    ?
                  </button>
                </div>
                <div className="grid place-items-end pr-5">
                  {isHovering && (
                    <h2 className="bg-green-400 shadow-md shadow-green-800 ">
